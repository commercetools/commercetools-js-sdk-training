    ...
    */
    execute: function execute(request) {
      ...
      return new Promise(function(resolve, reject) {
        ...
        var dispatch = compose.apply(
          undefined,
          _toConsumableArray(options.middlewares)
        )(resolver)
        dispatch(
          request,
    ...
    process: function process(request, fn, processOpt) {
      ...
      return new Promise(function(resolve, reject) {
        ...
        var requestQuery = _extends(
          {},
          _querystring2.default.parse(queryString)
        )
        var query = _extends(
          {
            // defaults
        ...
        var processPage = function processPage(lastId) {
          ...
          var originalQueryString = _querystring2.default.stringify(
            _extends({}, query, { limit: limit })
          )
          ...
          var enhancedQueryString = _querystring2.default.stringify(
            enhancedQuery
          )
