(function (global, factory) {
	...
	(factory((global.CommercetoolsSdkMiddlewareHttp = {}),global.require$$0,global.http,global.https,global.zlib,global.require$$1,global.require$$0$1,global.require$$1$1,global.util));
}(this, (function (exports,require$$0,http,https,zlib,require$$1,require$$0$1,require$$1$1,util) { 'use strict';
...
require$$1$1 = require$$1$1 && require$$1$1.hasOwnProperty('default') ? require$$1$1['default'] : require$$1$1;
 ...
 * @return  Object
 */
Headers$1.prototype.raw = function() {
...
Request$1.prototype = Object.create(body.prototype);
...
var parse_url = require$$0.parse;
var resolve_url = require$$0.resolve;
...
function NetworkError() {
  ...
  defineError.call.apply(defineError, [this, 0 /* special code to indicate network errors */
  ].concat(args));
}
function HttpError() {
...
function createError(_ref) {
  var statusCode = _ref.statusCode,
      ...
      rest = objectWithoutProperties(_ref, ['statusCode', 'message']);
...
function createHttpMiddleware(_ref2) {
  var host = _ref2.host,
      ...
      maskSensitiveHeaderData = _ref2.maskSensitiveHeaderData,
      enableRetry = _ref2.enableRetry,
      _ref2$retryConfig = _ref2.retryConfig;
  _ref2$retryConfig = _ref2$retryConfig === undefined ? {} : _ref2$retryConfig;
  var _ref2$retryConfig$max = _ref2$retryConfig.maxRetries,
      maxRetries = _ref2$retryConfig$max === undefined ? 10 : _ref2$retryConfig$max,
      _ref2$retryConfig$bac = _ref2$retryConfig.backoff,
      backoff = _ref2$retryConfig$bac === undefined ? true : _ref2$retryConfig$bac,
      _ref2$retryConfig$ret = _ref2$retryConfig.retryDelay,
      retryDelay = _ref2$retryConfig$ret === undefined ? 200 : _ref2$retryConfig$ret,
      _ref2$retryConfig$max2 = _ref2$retryConfig.maxDelay,
      maxDelay = _ref2$retryConfig$max2 === undefined ? Infinity : _ref2$retryConfig$max2;

  return function (next) {
    return function (request, response) {
      var url = host.replace(/\/$/, '') + request.uri;
      var body = typeof request.body === 'string' || Buffer.isBuffer(request.body) ? request.body : JSON.stringify(request.body);
      var requestHeader = _extends({
        'Content-Type': 'application/json'
      }, request.headers, body ? { 'Content-Length': Buffer.byteLength(body).toString() } : {});
      var requestObj = new Request(url, _extends({
      ...
      function executeFetch() {
        fetch(requestObj).then(function (res) {
          if (res.ok) {
            res.json().then(function (result) {
              var parsedResponse = _extends({}, response, {
                body: result,
                statusCode: res.status
              });
              if (includeResponseHeaders) parsedResponse.headers = parseHeaders(res.headers);
              if (includeOriginalRequest) {
                parsedResponse.request = _extends({}, requestObj, {
                  headers: parseHeaders(requestObj.headers)
                });
                if (maskSensitiveHeaderData) parsedResponse.request.headers.authorization = 'Bearer ********';
              }
          ...
          res.text().then(function (text) {
            ...
            var error = createError(_extends({
              statusCode: res.status,
              originalRequest: request,
              headers: parseHeaders(res.headers)
            }, (typeof parsed === 'undefined' ? 'undefined' : _typeof(parsed)) === 'object' ? { message: parsed.message, body: parsed } : { message: parsed, body: parsed }));
        ...
        function (e) {
          ...
          next(request, _extends({}, response, { error: error, statusCode: 0 }));
        });
      }
      executeFetch();
    };
